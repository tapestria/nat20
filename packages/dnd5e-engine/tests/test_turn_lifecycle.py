...
def test_hooks_registered_by_the_engine_are_present_and_ordered():
    """The two pre-F3a inline blocks are now registered hooks. Registration
    order is part of the seeded-replay contract, so it is pinned here."""

...
Nat20 does not implement all of SRD 5.2. Lair actions, summoning and
polymorph are among the rules it does not resolve today, and about a third of the spell corpus loads
